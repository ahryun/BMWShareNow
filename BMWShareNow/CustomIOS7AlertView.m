...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (i == 0) {
            [closeButton setTitleColor:[UIColor colorWithRed:(102/255.f) green:(102/255.f) blue:(102/255.f) alpha:1.0f] forState:UIControlStateNormal];
        } else {
            [closeButton setTitleColor:[UIColor colorWithRed:(31/255.f) green:(181/255.f) blue:(102/255.f) alpha:1.0f] forState:UIControlStateNormal];
        }
        [closeButton setTitleColor:[UIColor colorWithRed:0.2f green:0.2f blue:0.2f alpha:0.5f] forState:UIControlStateHighlighted];
        [closeButton.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:17.0]];
